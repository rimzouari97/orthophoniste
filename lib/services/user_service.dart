...
class UserService {
    ...
    return http.get(uri).then((data) {
      ...
      if (data.statusCode == 200) {
        ...
        for (var item in jsonData.values.first) {
          final user = User(item['_id'], item['name'], item['email'],
              item['type'], item['password']);
          users.add(user);
        }
      ...
      return APIResponse<List<User>>(errer: true, errorMessage: " An errer 1");
        ...
        APIResponse<List<User>>(errer: true, errorMessage: " An errer 2"));
  }

  Future<APIResponse<User>> Login(UserParam item) {
    //print(item.email+' '+item.password);
    return http
        .post(API + "auth", headers: headers, body: json.encode(item.toJson()))
        .then((data) {
      if (data.statusCode == 200) {
        final Map<String, dynamic> jsonData = json.decode(data.body);
        ...
        final user = User(item['id'], item['name'], item['email'],
            item['password'], item['type'],
            code: item['code'],
            phone: item['phone'],
            score: item['score'],
      ...
      return APIResponse<User>(errer: true, errorMessage: " An errer 1");
            ...
            (_) => APIResponse<User>(errer: true, errorMessage: " An errer 2"));
  }

  Future<APIResponse<String>> LoadStutterProgress(UserParam item) {
    //print(item.email+' '+item.password);
    return http
        .post(API + "auth", headers: headers, body: json.encode(item.toJson()))
        .then((data) {
      if (data.statusCode == 200) {
        ...
        return APIResponse<String>(data: item["progress"]);
      }
      return APIResponse<String>(errer: true, errorMessage: " An errer 1");
    }).catchError((_) =>
            APIResponse<String>(errer: true, errorMessage: " An errer 2"));
  }
      ...
      if (data.statusCode == 200) {
        ...
        if (jsonData["message"] != null) {
          return APIResponse<User>(
              errer: true, errorMessage: jsonData["message"]);
        } else {
          var item = jsonData["user"];
          final user = User(item['id'], item['name'], item['email'],
              item['type'], item['password'],
              phone: item['phone'], score: item['score']);
          return APIResponse<User>(data: user);
        }
      }
      return APIResponse<User>(errer: true, errorMessage: " An errer 1");
    }).catchError((_) =>
            APIResponse<User>(errer: true, errorMessage: " Opps server Errer"));
  }

  Future<APIResponse<User>> SignUpOrtho(UserParam item) {
    print(json.encode(item.toJson()));
    return http
        .post(API + "registerOrtho",
            headers: headers, body: json.encode(item.toJson()))
        .then((data) {
      print(data.statusCode.toString());
      if (data.statusCode == 200) {
        ...
        if (jsonData["message"] != null) {
          ...
          final user = User(item['id'], item['name'], item['email'],
              item['type'], item['password'],
              code: item['code'], phone: item['phone'], score: item['score']);
          return APIResponse<User>(data: user);
        }
      }
      return APIResponse<User>(errer: true, errorMessage: " An errer 1");
  ...
  Future<bool> getHasOrthoByIdP(UserParam item) {
    print(json.encode(item.toJson()));
    return http
        .post(BASE_URL + "hasOrth/" + "getByIdP",
            headers: headers, body: json.encode(item.toJson()))
        .then((data) {
      print(data.statusCode.toString());
      if (data.statusCode == 200) {
  ...
  Future<List<OrthoParam>> gatAllByIdOrtho(UserParam item) {
    ...
    return http
        .post(BASE_URL + "hasOrth/" + "getByIdOrtho",
            headers: headers, body: json.encode(item.toJson()))
        .then((data) {
      print(data.statusCode.toString());
      // print(data.body);
  ...
  Future<APIResponse<OrthoParam>> getPatient(OrthoParam item) {
    // print(json.encode(item.toJson()));
    return http
        .post(BASE_URL + "hasOrth/" + "getPatient",
            headers: headers, body: json.encode(item.toJson()))
        .then((data) {
      // print(data.statusCode.toString() );
      List<OrthoParam> list = <OrthoParam>[];
    ...
    }).catchError((_) => APIResponse<OrthoParam>(
            errer: true, errorMessage: " Opps server Errer"));
  }

  Future<bool> getAllExercice() {
    return http.get(BASE_URL + "exercices/list", headers: headers).then((data) {
      print(data.statusCode.toString());
      if (data.statusCode == 200) {
        Map<String, dynamic> jsonData = json.decode(data.body);
        print(jsonData);
      ...
      return APIResponse<OrthoParam>(errer: true, errorMessage: " An errer 1");
        ...
        APIResponse<Exercice>(errer: true, errorMessage: " Opps server Errer"));
  }
  ...
  Future<APIResponse<ToDoParam>> addToDo(ToDoParam item) {
    ...
    }).catchError((_) => APIResponse<ToDoParam>(
            errer: true, errorMessage: " Opps server Errer"));
  }
