...
import 'package:orthophoniste/models/virus.dart';
import 'package:page_transition/page_transition.dart';
import 'package:rflutter_alert/rflutter_alert.dart';
import 'package:soundpool/soundpool.dart';
import 'package:orthophoniste/models/score.dart';
import 'package:orthophoniste/screens/scorepage.dart';
import 'package:orthophoniste/screens/settingspage.dart';
//import 'package:orthophoniste/models/virus.dart';
//import 'package:orthophoniste/utils/virusstatus.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        label: _timerRunning ? Text('Stop Game') : Text('Commencer le jeu'),
        onPressed: () async {
          if (_timerRunning) {
            _timer.cancel();
        ...
        child: Conditioned(
          cases: [
            Case(
              ...
              builder: () => Image.asset("assets/images/virus_white.png"),
            ),
            Case(
            ...
            Case(
              v.status == VirusStatus.whacked,
              builder: () => Image.asset("assets/images/virus_whacked.png"),
            ),
          ],
