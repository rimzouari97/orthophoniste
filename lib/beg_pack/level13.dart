...
class _Page13 extends StatefulWidget {
  @override
  __Page13State createState() => __Page13State();
}

class __Page13State extends State<_Page13> {
                ...
                child: NeumorphicButton(
                  onPressed: () async {
                    ...
                    if (_correct.compareTo(_textSpeech.toLowerCase()) == 0) {
                      await StutterService.saveStutterProgress(14);
                      await showDialog(
                        context: context,
