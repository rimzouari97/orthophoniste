...
class _Page10 extends StatefulWidget {
  @override
  __Page10State createState() => __Page10State();
}

class __Page10State extends State<_Page10> {
                ...
                child: NeumorphicButton(
                  onPressed: () async {
                    ...
                    if (_correct.compareTo(_textSpeech.toLowerCase()) == 0) {
                      await StutterService.saveStutterProgress(11);
                      await showDialog(
                        context: context,
