...
class _Page4 extends StatefulWidget {
  @override
  __Page4State createState() => __Page4State();
}

class __Page4State extends State<_Page4> {
  stt.SpeechToText _speech;
  bool _isListening = false;
  String _textSpeech = 'press the button to start speaking';
  String _correct = 'paint power pardon pass pearl penny pie play';
            ...
            children: <Widget>[
              ...
              Container(
                child: Lottie.network(
                    'https://assets5.lottiefiles.com/packages/lf20_3vbOcw.json'),
                alignment: Alignment.center,
                ...
                child: NeumorphicButton(
                  onPressed: () async {
                    ...
                    if (_correct.compareTo(_textSpeech.toLowerCase()) == 0) {
                      await StutterService.saveStutterProgress(5);
                      await showDialog(
                        context: context,
