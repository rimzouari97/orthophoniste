...
class Level18 extends StatelessWidget {
  @override
...
class _Page18 extends StatefulWidget {
  @override
  __Page18State createState() => __Page18State();
}

class __Page18State extends State<_Page18> {
                ...
                child: NeumorphicButton(
                  onPressed: () async {
                    ...
                    if (_correct.compareTo(_textSpeech.toLowerCase()) == 0) {
                      await StutterService.saveStutterProgress(18);
                      await showDialog(
                        context: context,
