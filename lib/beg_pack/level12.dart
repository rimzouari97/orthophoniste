...
class _Page12 extends StatefulWidget {
  @override
  __Page12State createState() => __Page12State();
}

class __Page12State extends State<_Page12> {
                ...
                child: NeumorphicButton(
                  onPressed: () async {
                    ...
                    if (_correct.compareTo(_textSpeech.toLowerCase()) == 0) {
                      await StutterService.saveStutterProgress(13);
                      await showDialog(
                        context: context,
