...
class _Page14 extends StatefulWidget {
  @override
  __Page14State createState() => __Page14State();
}

class __Page14State extends State<_Page14> {
                ...
                child: NeumorphicButton(
                  onPressed: () async {
                    ...
                    if (_correct.compareTo(_textSpeech.toLowerCase()) == 0) {
                      await StutterService.saveStutterProgress(15);
                      await showDialog(
                        context: context,
