...
class _Page11 extends StatefulWidget {
  @override
  __Page11State createState() => __Page11State();
}

class __Page11State extends State<_Page11> {
                ...
                child: NeumorphicButton(
                  onPressed: () async {
                    ...
                    if (_correct.compareTo(_textSpeech.toLowerCase()) == 0) {
                      await StutterService.saveStutterProgress(12);
                      await showDialog(
                        context: context,
