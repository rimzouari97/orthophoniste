...
class _Page8 extends StatefulWidget {
  @override
  __Page8State createState() => __Page8State();
}

class __Page8State extends State<_Page8> {
                ...
                child: NeumorphicButton(
                  onPressed: () async {
                    ...
                    if (_correct.compareTo(_textSpeech.toLowerCase()) == 0) {
                      await StutterService.saveStutterProgress(9);
                      await showDialog(
                        context: context,
