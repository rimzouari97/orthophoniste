...
class _Page7 extends StatefulWidget {
  @override
  __Page7State createState() => __Page7State();
}

class __Page7State extends State<_Page7> {
  stt.SpeechToText _speech;
  bool _isListening = false;
  String _textSpeech = 'press the button to start speaking';
  String _correct =
      'matter better letter battle settle glitter setting attention';
                ...
                child: NeumorphicButton(
                  onPressed: () async {
                    ...
                    if (_correct.compareTo(_textSpeech.toLowerCase()) == 0) {
                      await StutterService.saveStutterProgress(8);
                      await showDialog(
                        context: context,
